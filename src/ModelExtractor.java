...
//        for(Map.Entry<Integer,Integer> entry : genealogy.entrySet()){
...
//		System.out.println();
    ...
    public double getCosineSimilarityScore(String faultyNode, String fixingIngredient) {
        return cosine.similarity(faultyNode, fixingIngredient);
    }

    public double getJaroWinklerDistance(String s1, String s2) {
    ...
    public double getJaccardDistance(String s1, String s2) {
